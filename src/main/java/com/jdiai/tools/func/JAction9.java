...
@FunctionalInterface
public interface JAction9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    void invoke(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5,
    ...
    default void execute(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5,
        ...
        try {
            invoke(val1, val2, val3, val4, val5, val6, val7, val8, val9);
        } catch (Exception ex) {
